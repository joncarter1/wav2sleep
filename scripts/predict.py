...
def parse_args():
    ...
    parser.add_argument(
        '--model-folder',
        default='hf://joncarter/wav2sleep',
        help='Local folder or HF Hub URI (e.g., hf://joncarter/wav2sleep) containing model config and weights.',
    )
    parser.add_argument(
        '--signals',
        default=None,
...
def main():
    ...
    predictions, labels = predict_on_folder(
